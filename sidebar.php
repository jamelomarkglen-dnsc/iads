...
$adviserDefensePages = [
    'my_assigned_defense.php',
    'adviser_route_slip.php',
    'route_slip_inbox.php',
        ...
        <div class="nav-links flex-grow-1 d-flex flex-column">
            ...
            <div class="nav-group nav-role flex-grow-1 d-flex flex-column">
                ...
                <?php if ($role === 'adviser'): ?>
                    ...
                    <div class="nav-section<?php echo $adviserDefenseOpen ? ' open' : ''; ?>" data-section="adviser-defense" data-accordion="true">
                        ...
                        <div class="nav-section-links">
                            ...
                            <a href="final_defense_committee_dashboard.php" class="nav-sub-link <?php echo ($currentPage == 'final_defense_committee_dashboard.php') ? 'active' : ''; ?>">
                                Final Defense Inbox
                            </a>
                        </div>
                    </div>
                ...
                <?php if ($role === 'committee_chair'): ?>
                    ...
                    <a href="final_defense_committee_dashboard.php" class="nav-link <?php echo ($currentPage == 'final_defense_committee_dashboard.php') ? 'active' : ''; ?>">
