...
$submissions = fetch_final_routing_submissions_for_reviewer($conn, $reviewer_id, $reviewer_role);
...
<head>
    <meta charset="UTF-8">
    <title>Final Routing Inbox</title>
...
<div class="content">
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h3 class="fw-bold text-success mb-1">Final Routing Inbox</h3>
                <p class="text-muted mb-0">Review final routing submissions assigned to you.</p>
            </div>
        </div>
            ...
            <div class="card-body p-0">
                <?php if (empty($submissions)): ?>
                    <div class="text-center text-muted py-4">
                        ...
                        No final routing submissions assigned yet.
                    </div>
                <?php else: ?>
                            ...
                            <tbody>
                                <?php foreach ($submissions as $submission): ?>
                                    <?php
                                        ...
                                        $statusBadge = final_routing_status_badge($submission['status'] ?? 'Submitted');
                                    ?>
                                    <tr class="<?php echo $rowHighlight; ?>">
                                        ...
                                        <td class="text-end">
                                            <a class="btn btn-sm btn-outline-success" href="committee_final_routing_review.php?submission_id=<?php echo (int)$submission['id']; ?>">
                                                Review
                                            </a>
                                        </td>
                                    </tr>
