...
{
$message = 'The selected title options do not belong to the selected student.';
$messageClass = 'danger';
}
 if (!$message)
{
...
{$roleLabel}
 to review the title options submitted by
{$studentName}
...
notify_user( $conn, (int)$rid, 'Review assignment', $body, $dashboardLink, false );
 ...
 if ($studentId > 0)
{
$studentMessage = 'Reviewers were assigned to evaluate your title options.';
if ($dueDate)
{
...
.content { margin-left: 220px; padding: 28px; min-height: 100vh; transition: margin-left .3s; }
...
.hero-card .text-white-50 { color: var(--muted) !important; }
.hero-card .badge { background: var(--accent-50); color: var(--accent-600); border: 1px solid rgba(22, 86, 44, 0.18); }
...
.stage-progress { height: 6px; border-radius: 999px; background: rgba(12, 53, 22, 0.08); overflow: hidden; }
...
.student-card { overflow: hidden; }
.student-card .list-group-item { border: none; border-bottom: 1px solid var(--border); }
...
.assign-form select { min-height: 44px; }
.assign-form textarea { resize: vertical; }

.review-brief {
  border-radius: 14px;
  border: 1px dashed rgba(22, 86, 44, 0.2);
  background: #f7faf7;
  padding: 0.85rem 1rem;
}
.status-pill { border-radius: 999px; padding: 0.2rem 0.75rem; font-size: 0.78rem; font-weight: 600; display: inline-flex; gap: 0.25rem; align-items: center; }

.role-icon { width: 36px; height: 36px; border-radius: 10px; background: rgba(22, 86, 44, 0.12); display: inline-flex; align-items: center; justify-content: center; color: var(--accent-600); }
.role-description { font-size: 0.8rem; color: var(--muted); }
...
.reviewer-pill.completed { background: rgba(72, 180, 97, 0.12); border-color: rgba(72, 180, 97, 0.35); color: #0f6631; }
.reviewer-pill.pending { background: rgba(255, 193, 7, 0.12); border-color: rgba(255, 193, 7, 0.35); color: #945400; }

.reviewer-list { list-style: none; padding: 0; margin: 0; }
.reviewer-list li { display: flex; justify-content: space-between; align-items: center; padding: 0.35rem 0; border-bottom: 1px solid var(--border); }
.reviewer-list li:last-child { border-bottom: 0; }
.reviewer-chip { background: rgba(22, 86, 44, 0.08); border-radius: 999px; padding: 0.15rem 0.65rem; font-size: 0.85rem; color: var(--accent-600); }
...
@media (max-width: 1199px) { .assignment-layout { grid-template-columns: 1fr; } }

.concept-panel { display: flex; flex-direction: column; gap: 1rem; }
.concept-header { display: flex; flex-direction: column; gap: 0.35rem; }
.concept-chip {
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
.concept-stack { display: flex; flex-direction: column; gap: 0.75rem; }
.role-summary-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 0.75rem; }
.role-summary-card { border: 1px solid var(--border); border-radius: 14px; padding: 0.75rem; background: #fafbfe; }
.role-summary-card p { font-size: 0.72rem; text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 0.4rem; color: var(--muted); }
...
.concept-row h6 { margin: 0 0 0.25rem; font-size: 1rem; }
.concept-meta { font-size: 0.8rem; color: var(--muted); }
.status-chip { border-radius: 12px; padding: 0.35rem 0.9rem; font-size: 0.78rem; text-transform: uppercase; }

.assign-panel { display: flex; flex-direction: column; gap: 1.25rem; }
.reviewer-role-strip { display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 0.85rem; }
.reviewer-role-group {
  border: 1px solid var(--border);
  border-radius: 14px;
  padding: 0.85rem 1rem;
...
.reviewer-role-group .role-title { display: block; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; color: var(--muted); letter-spacing: 0.08em; }
.reviewer-role-group select { border-radius: 10px; border: 1px solid var(--border); }
.reviewer-role-group select:focus { border-color: rgba(22, 86, 44, 0.5); box-shadow: 0 0 0 0.15rem rgba(22, 86, 44, 0.12); }
.reviewer-role-group small { font-size: 0.75rem; color: var(--muted); }
...
.concept-instructions-box { margin-top: 1rem; border: 1px solid var(--border); }
